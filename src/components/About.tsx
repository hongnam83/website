...
export default function About() {
  const features = [
    {
      icon: Target,
      title: "Chuyên Biệt Hóa",
      description: "Formula được nghiên cứu dành riêng cho môi trường răng miệng phức tạp khi đeo mắc cài hay khay niềng Invisalign."
    },
    {
      icon: Leaf,
      title: "Thành Phần Tự Nhiên",
      description: "Kết hợp tinh chất Trà Xanh, Lô Hội, và Rau Má giúp làm dịu niêm mạc, giảm nhiệt miệng an toàn, lành tính."
    },
    {
      icon: HeartPulse,
      title: "Hiệu Quả Lâm Sàng",
      description: "Bảo vệ men răng, ngăn chặn vệt trắng (white spots) và viêm nướu - những nỗi ám ảnh lớn nhất của team niềng."
    }
  ];
          ...
          >
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-6">
              <div className="border-l-2 border-brand-200 pl-4">
                ...
                <p className="text-sm text-gray-500">Khách hàng giảm hẳn tình trạng sưng nướu</p>
              </div>
              <div className="border-l-2 border-brand-200 pl-4">
                <p className="text-3xl font-bold text-gray-900 mb-1">7x</p>
                <p className="text-sm text-gray-500">Làm sạch sâu hơn so với sản phẩm thông thường</p>
              </div>
            </div>
          </motion.div>
